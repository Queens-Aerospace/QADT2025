...
#ifndef PX4__MSG__DETAIL__ROVER_ACKERMANN_SETPOINT__TRAITS_HPP_
#define PX4__MSG__DETAIL__ROVER_ACKERMANN_SETPOINT__TRAITS_HPP_
...
inline void to_yaml(
  const px4::msg::RoverAckermannSetpoint & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4::msg::RoverAckermannSetpoint & msg)
{
  return px4::msg::to_yaml(msg);
}

template<>
inline const char * data_type<px4::msg::RoverAckermannSetpoint>()
{
  return "px4::msg::RoverAckermannSetpoint";
}

template<>
inline const char * name<px4::msg::RoverAckermannSetpoint>()
{
  return "px4/msg/RoverAckermannSetpoint";
}

template<>
struct has_fixed_size<px4::msg::RoverAckermannSetpoint>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<px4::msg::RoverAckermannSetpoint>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<px4::msg::RoverAckermannSetpoint>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // PX4__MSG__DETAIL__ROVER_ACKERMANN_SETPOINT__TRAITS_HPP_
