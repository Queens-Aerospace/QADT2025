...
#ifndef PX4__MSG__DETAIL__ROVER_DIFFERENTIAL_STATUS__STRUCT_HPP_
#define PX4__MSG__DETAIL__ROVER_DIFFERENTIAL_STATUS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__px4__msg__RoverDifferentialStatus __attribute__((deprecated))
#else
# define DEPRECATED__px4__msg__RoverDifferentialStatus __declspec(deprecated)
#endif
...
struct RoverDifferentialStatus_
{
  ...
  // pointer types
  using RawPtr =
    px4::msg::RoverDifferentialStatus_<ContainerAllocator> *;
  using ConstRawPtr =
    const px4::msg::RoverDifferentialStatus_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<px4::msg::RoverDifferentialStatus_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<px4::msg::RoverDifferentialStatus_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      px4::msg::RoverDifferentialStatus_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<px4::msg::RoverDifferentialStatus_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<px4::msg::RoverDifferentialStatus_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<px4::msg::RoverDifferentialStatus_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<px4::msg::RoverDifferentialStatus_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__px4__msg__RoverDifferentialStatus
    std::shared_ptr<px4::msg::RoverDifferentialStatus_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__px4__msg__RoverDifferentialStatus
    std::shared_ptr<px4::msg::RoverDifferentialStatus_<ContainerAllocator> const>
...
using RoverDifferentialStatus =
  px4::msg::RoverDifferentialStatus_<std::allocator<void>>;
...
#endif  // PX4__MSG__DETAIL__ROVER_DIFFERENTIAL_STATUS__STRUCT_HPP_
