...
#ifndef PX4__MSG__DETAIL__ROVER_ACKERMANN_STATUS__STRUCT_HPP_
#define PX4__MSG__DETAIL__ROVER_ACKERMANN_STATUS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__px4__msg__RoverAckermannStatus __attribute__((deprecated))
#else
# define DEPRECATED__px4__msg__RoverAckermannStatus __declspec(deprecated)
#endif
...
struct RoverAckermannStatus_
{
  ...
  // pointer types
  using RawPtr =
    px4::msg::RoverAckermannStatus_<ContainerAllocator> *;
  using ConstRawPtr =
    const px4::msg::RoverAckermannStatus_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<px4::msg::RoverAckermannStatus_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<px4::msg::RoverAckermannStatus_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      px4::msg::RoverAckermannStatus_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<px4::msg::RoverAckermannStatus_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<px4::msg::RoverAckermannStatus_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<px4::msg::RoverAckermannStatus_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<px4::msg::RoverAckermannStatus_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__px4__msg__RoverAckermannStatus
    std::shared_ptr<px4::msg::RoverAckermannStatus_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__px4__msg__RoverAckermannStatus
    std::shared_ptr<px4::msg::RoverAckermannStatus_<ContainerAllocator> const>
...
using RoverAckermannStatus =
  px4::msg::RoverAckermannStatus_<std::allocator<void>>;
...
#endif  // PX4__MSG__DETAIL__ROVER_ACKERMANN_STATUS__STRUCT_HPP_
